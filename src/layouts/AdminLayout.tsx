...
export default function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      <aside className="w-56 bg-white border-r p-6 text-nowrap shadow-md flex flex-col">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger>
            <Button asChild variant={"ghost"} className="w-full justify-start text-lg hover:bg-red-50">
